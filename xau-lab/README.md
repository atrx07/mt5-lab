...
Experiment 36 completed the outcome-blind microstate-v1 foundation: 23 raw-event features reached 100% coverage with strict cross-grid median Spearman 0.869 historical and 0.935 recent. This is retained only as new causal information. We are intentionally stopping known-window strategy search here; the next strategy-changing hypothesis must be frozen before a genuinely new non-overlapping snapshot is evaluated.
