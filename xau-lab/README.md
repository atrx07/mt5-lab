...
V4.1 is a research candidate, not a profitability claim. Its validation sample contains only eight trades, and the locked holdout still has to be evaluated.
...
A candidate only graduates when it survives realistic bid/ask execution, untouched holdout data, multiple regimes, drawdown checks, stress tests and live-paper validation.
