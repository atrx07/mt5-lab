...
The complete experiment interpretation, data-clock caveat, selection discipline and next step are in `docs/experiments/2026-09-24/22-recent-micro-long-validation.md`. Restore the ignored raw CSVs with `tools/restore_dataset.py` before reproducing the evidence. No broker order was sent.
