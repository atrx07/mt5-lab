...
# V4.2 secondary breakout engine (config hash f75134b98dc1).
...
LOG_FILE = Path("paper_trades_v4_2.csv")
HOURLY_LOG_FILE = Path("paper_hourly_v4_2.csv")
...
print("================================================")
print("      XAUUSD LIVE PAPER CHALLENGE V4.2")
print("================================================")
print("V4.1 primary + secondary breakout outside slow gate")
...
try:
    while True:
        ...
        if position is not None:
            ...
            if reason is None and m300 is not None:
        ...
        if side is None and now - last_secondary_exit_time >= SECONDARY_COOLDOWN_SECONDS:
